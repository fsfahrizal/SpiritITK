...
public class FasilitasITK extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fasilitas_itk);
    ...
    public void onBackPressed() {
        Intent pindah = new Intent(FasilitasITK.this,MainActivity.class);
...
//        }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.fasilitas_itk, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_prodi) {
            ...
            Intent i = new Intent(FasilitasITK.this, JalurPendaftaran.class);
            startActivity(i);

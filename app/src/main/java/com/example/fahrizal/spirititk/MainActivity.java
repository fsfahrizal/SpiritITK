...
//                        .setAction("Action", null).show();
                ...
                if(!flag) {
//                    fabShare.animate().rotationBy(-90);
                    fabOne.animate().translationXBy(-150).translationYBy(-150).rotation(720).setDuration(200);
                    fabTwo.animate().translationXBy(150).translationYBy(-150).rotation(720).setDuration(200);
                    flag = true;
                } else
                {
//                    fabShare.animate().rotationBy(90);
